...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="deadline.jsp"><span class="fa fa-user mr-3"></span>Task's Deadline</a>
	          </li>
	          <li>
	          ...
	          <li>
              <a href="viewComment.jsp"><span class="fa fa-cogs mr-3"></span>View Comments</a>
	          </li>
	          <li>
 ...
 <table class="table">
    ...
    try
  {
		...
		PreparedStatement ps=con.prepareStatement("select * from comment where department=?");
