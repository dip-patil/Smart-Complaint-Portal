...
<html lang="en">
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	           ...
	           <li>
	              <a href="viewUserComment.jsp"><span class="fa fa-user mr-3"></span>View Comment</a>
	          </li>
	          <li>
 ...
 <table class="table">
    ...
    try
  {
		...
		PreparedStatement ps=con.prepareStatement("select * from complaint where sender=?");
		...
		while(rs.next())
		{
			...
			<tbody>
			    ...
			    <tr>
			      ...
			      <td><a href="deleteComp.jsp?dname=<%=rs.getString(2)%>"/a>Delete</td>
